...
<div class="header">
    <nav class="navbar navbar-light bg-light navbar-expand-md sticky-top">
        ...
        <li class="nav-item">
            <a class="nav-link h5 active" href="astaff.jsp"><i class="fa fa-plus"></i> Add new Staff</a>
        </li>
...
<fieldset class="jumbotron bg-transparent" style="border: 4px solid grey;">
  <legend class="h4 text-primary">Add staff</legend>
    <div class="alert alert-primary alert-dismissible fade show sticky-top" role="alert">
  To manage existing users click <a href="modst.jsp" class="h6">here</a>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
  <form action="./astservlet" method="post" class="jumbotron bg-transparent border border-primary" style="border-radius:20px;">
