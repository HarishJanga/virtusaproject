...
<div class="header">
    <nav class="navbar navbar-light bg-light navbar-expand-md sticky-top">
        ...
        <li class="nav-item">
            <a class="nav-link h5 active" href="asupervisor.jsp"><i class="fa fa-plus"></i> Add new Supervisor-Modify</a>
        </li>
        <li class="nav-item">
...
<%
ResultSet rsb1=stmt.executeQuery("SELECT * from srdetails");
 if (rsb1.next() == false) {%>
...
<td><%= rsb1.getString("srmail") %></td>
<td><%= rsb1.getString("srpass") %></td>
</tr>
<% }while(rsb1.next()); %>
</table>
 <%} %>   
...
<div class="form-group collapse" id="cmplt1">
   <fieldset class="jumbotron bg-transparent" style="border: 5px solid grey;">
  <legend class="h4 text-primary">Update supervisor users</legend>
 ...
 Please check existing user details in the show current users tab!!
  ...
  <form action="./mdservlet" method="post" class="jumbotron bg-transparent" style="border:1px solid blue;border-radius:20px;">
   ...
   <br>
   <form action="./dservlet" method="post" class="jumbotron bg-transparent" style="border:1px solid blue;border-radius:20px;">
    <div class="col-sm-6 mb-3 mb-sm-0">
