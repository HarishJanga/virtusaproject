...
ResultSet rs=stmt.executeQuery("SELECT * from complaints where cmail='"+un+"'");
%>
<body>
<div class="header">
    <nav class="navbar navbar-light bg-light navbar-expand-md sticky-top">
        ...
        <li class="nav-item">
            <a class="nav-link active h5" href="contact.html"><i class="fa fa-comments fa-2x text-gray-300"></i> My Complaint-requests</a>
        </li>
    </ul>
...
<p class="h3 text-primary text-center">My complaints</p>
